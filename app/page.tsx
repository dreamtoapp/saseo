      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Revenue Projections */}
            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white p-8 rounded-2xl shadow-xl">
              <h3 className="text-2xl font-bold text-center mb-6 text-white">توقعات الإيراد مع المصادر الإضافية</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white/20 backdrop-blur-sm p-6 rounded-xl border border-white/30 hover:bg-white/30 transition-colors">
                  <h4 className="font-bold text-lg mb-2 text-white">السيناريو 1</h4>
                  <p className="text-sm mb-2 text-white/90">المستوى 1 فقط (3 أشهر)</p>
                  <p className="text-3xl font-bold text-white">3.35M</p>
                  <p className="text-sm text-white/90">ريال/سنة (+41%)</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm p-6 rounded-xl border border-white/30 hover:bg-white/30 transition-colors">
                  <h4 className="font-bold text-lg mb-2 text-white">السيناريو 2</h4>
                  <p className="text-sm mb-2 text-white/90">المستوى 1 + 2 (6 أشهر)</p>
                  <p className="text-3xl font-bold text-white">8.8M</p>
                  <p className="text-sm text-white/90">ريال/سنة (+270%)</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm p-6 rounded-xl border border-white/30 hover:bg-white/30 transition-colors">
                  <h4 className="font-bold text-lg mb-2 text-white">السيناريو 3</h4>
                  <p className="text-sm mb-2 text-white/90">جميع المستويات (12 شهر)</p>
                  <p className="text-3xl font-bold text-white">12.3M</p>
                  <p className="text-sm text-white/90">ريال/سنة (+417%)</p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                نظامنا المكون من 3 منصات متكاملة
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                فهم واضح لكيفية عمل المنصات الثلاث معاً لتحقيق أهدافنا
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {/* Domain 1: jrbseo.com */}
              <Card className="bg-white shadow-xl border-2 border-blue-200 hover:border-brand-primary transition-all">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center text-xl font-bold">
                      1
                    </div>
                    <CardTitle className="text-2xl text-blue-600">jrbseo.com</CardTitle>
                  </div>
                  <Badge className="bg-blue-100 text-blue-700">المنصة الأساسية</Badge>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    المنصة الرئيسية للعملاء والاشتراكات
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">شرح الفكرة والقيمة المضافة</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">جذب العملاء والتسجيل</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">إدارة الاشتراكات والدفعات</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">معلومات المشروع الشاملة</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>

              {/* Domain 2: Modonty.com */}
              <Card className="bg-white shadow-xl border-2 border-green-200 hover:border-green-500 transition-all">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full bg-green-600 text-white flex items-center justify-center text-xl font-bold">
                      2
                    </div>
                    <CardTitle className="text-2xl text-green-600">Modonty.com</CardTitle>
                  </div>
                  <Badge className="bg-green-100 text-green-700">نظام المحتوى</Badge>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    النظام الأساسي لإنشاء وإدارة المقالات
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">إنشاء المقالات وتحريرها</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">نشر المقالات وإدارتها</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">تسليم المحتوى للعملاء</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">إدارة المدونة المركزية</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>

              {/* Domain 3: jbrtechno.com */}
              <Card className="bg-white shadow-xl border-2 border-purple-200 hover:border-purple-500 transition-all">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full bg-purple-600 text-white flex items-center justify-center text-xl font-bold">
                      3
                    </div>
                    <CardTitle className="text-2xl text-purple-600">jbrtechno.com</CardTitle>
                  </div>
                  <Badge className="bg-purple-100 text-purple-700">الإدارة والعمليات</Badge>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    لوحة التحكم الداخلية والعمليات الإدارية
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">لوحة تحكم الإدارة</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">لوحة تحكم الأدمن</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">توظيف وإدارة الموظفين</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">العمليات الداخلية والتنسيق</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-brand-primary">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold mb-1">العميل يصل عبر jrbseo.com</h4>
                    <p className="text-sm text-gray-700">
                      العميل يزور jrbseo.com، يفهم الفكرة، يسجل اشتراكه، ويدفع
                    </p>
                  </div>
                </div>
                <div className="flex items-center justify-center">
                  <ArrowRight className="h-6 w-6 text-brand-primary rotate-90 md:rotate-0" />
                </div>
                <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold mb-1">Modonty.com ينشئ المحتوى</h4>
                    <p className="text-sm text-gray-700">
                      النظام في Modonty.com يستقبل طلب العميل، ينشئ المقالات، ويسلمها للعميل
                    </p>
                  </div>
                </div>
                <div className="flex items-center justify-center">
                ...
                <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold mb-1">jbrtechno.com يدير العمليات</h4>
                    <p className="text-sm text-gray-700">
                      الفريق الإداري يستخدم jbrtechno.com لإدارة الموظفين، متابعة الأداء، وتنسيق العمل
                    </p>
                  </div>
                </div>
              </div>
